  ...
  /**
    ...
    private static function personnelDefinitions(): array
    {
        return [
            ...
            ['slug' => 'personnel.view_restricted', 'module' => 'personnel', 'action' => 'view', 'name' => 'Voir les personnels restreints / anonymisés'],
            ['slug' => 'personnel.view_hidden', 'module' => 'personnel', 'action' => 'view', 'name' => 'Voir les personnels masqués'],
            ['slug' => 'personnel.manage_visibility', 'module' => 'personnel', 'action' => 'manage', 'name' => 'Gérer la visibilité des personnels'],
    ...
    private static function organizationDefinitions(): array
    {
        return [
            ...
            ['slug' => 'organization.view_restricted_units', 'module' => 'organization', 'action' => 'view', 'name' => 'Voir les unités restreintes / anonymisées'],
            ['slug' => 'organization.view_hidden_units', 'module' => 'organization', 'action' => 'view', 'name' => 'Voir les unités masquées'],
            ['slug' => 'organization.manage_unit_visibility', 'module' => 'organization', 'action' => 'manage', 'name' => 'Gérer la visibilité des unités'],
