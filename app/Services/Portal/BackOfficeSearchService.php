...
final class BackOfficeSearchService
{
    ...
    private function pageCatalog(Gate $gate): array
    {
        ...
        $all = [
            ...
            ['title' => 'Images d’accueil', 'subtitle' => 'Photos de l’écran de bienvenue après connexion', 'href' => url('back-office/organisation/parametres') . '#accueil-connexion', 'keywords' => 'images accueil bienvenue connexion photos défilement écran', 'ok' => $org || $gate->allows('admin.settings.manage')],
