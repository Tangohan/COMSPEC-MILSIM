...
final class MilitaryOperationalRoleCatalogData
{
    ...
    private static function appendAerocombat(callable $a): void
    {
        ...
        $a('aero_160th_soar_pilot', 'Pilote opérations spéciales — 160th SOAR', '160th SOAR Special Operations Aviator', $c, 'Aviation opérations spéciales', 'Pilote Army Aviation sélectionné par le 160th SOAR pour l’infiltration, l’exfiltration et le soutien aérien des forces spéciales.', 'specialty', 0, self::DG_AERO, 70, 70, 'all');
    }
    ...
    private static function appendForcesSpeciales(callable $a): void
    {
        ...
        $a('sf_cag_b_squadron_operator', 'Opérateur — B Squadron (CAG)', 'B Squadron Operator (CAG)', $c, 'Unités de mission spéciale', 'Poste de simulation inspiré du B Squadron historiquement documenté ; désignation professionnelle actuelle non publique.', 'specialty', 0, self::DG_SF, 90, 90, 'all');
    }
