...
class Container
{
    ...
    private static function build(string $id): object
    {
        ...
        return match ($id) {
            ...
            \App\Repositories\RoleplayGameSessionRepository::class => new \App\Repositories\RoleplayGameSessionRepository(),
            \App\Repositories\PersonnelPhaseRepository::class => new \App\Repositories\PersonnelPhaseRepository(),
            \App\Services\Personnel\RoleplayGameSessionService::class => new \App\Services\Personnel\RoleplayGameSessionService(
                self::get(\App\Repositories\RoleplayGameSessionRepository::class),
                self::get(UserRepository::class),
            ),
            \App\Services\Personnel\PhaseRules\PhaseRuleEngine::class => new \App\Services\Personnel\PhaseRules\PhaseRuleEngine(),
            \App\Services\Personnel\PhaseRules\PhaseFactsLoader::class => new \App\Services\Personnel\PhaseRules\PhaseFactsLoader(
                self::get(UserRepository::class),
                self::get(\App\Repositories\PersonnelProfileRepository::class),
                self::get(\App\Repositories\PersonnelQualificationRepository::class),
                self::get(\App\Repositories\TrainingEnrollmentRepository::class),
                ...
                new \App\Services\Personnel\SeniorityEngine(),
                self::get(\App\Repositories\ModerationRepository::class),
                self::get(\App\Repositories\PersonnelPhaseRepository::class),
            ),
            \App\Services\Personnel\PhaseRules\PhaseTransitionService::class => new \App\Services\Personnel\PhaseRules\PhaseTransitionService(
                self::get(\App\Repositories\PersonnelPhaseRepository::class),
                self::get(\App\Repositories\PersonnelProfileRepository::class),
                self::get(UserRepository::class),
                self::get(\App\Services\Personnel\PhaseRules\PhaseRuleEngine::class),
                self::get(\App\Services\Personnel\PhaseRules\PhaseFactsLoader::class),
            ),
            \App\Controllers\Admin\Organization\PersonnelPhaseAdminController::class => new \App\Controllers\Admin\Organization\PersonnelPhaseAdminController(
                self::get(\App\Repositories\PersonnelPhaseRepository::class),
                self::get(\App\Services\Personnel\PhaseRules\PhaseRuleEngine::class),
            ...
            \App\Services\Cron\Jobs\PersonnelPhaseAutoCronJob::class => new \App\Services\Cron\Jobs\PersonnelPhaseAutoCronJob(
                self::get(TenantRepository::class),
                self::get(\App\Services\Personnel\PhaseRules\PhaseTransitionService::class),
            ),
            ...
            \App\Controllers\Web\EnlistmentController::class => new \App\Controllers\Web\EnlistmentController(
                ...
                self::get(\App\Services\Moderation\AiTextLikelihoodDetector::class),
            ),
            \App\Services\Moderation\AiTextLikelihoodDetector::class => new \App\Services\Moderation\AiTextLikelihoodDetector(),
            ...
            \App\Controllers\Web\DocumentInboxController::class => new \App\Controllers\Web\DocumentInboxController(
                self::get(\App\Services\Doctrine\DocumentInboxService::class),
            ),
            \App\Repositories\Doctrine\DocumentDoctrineRepository::class => new \App\Repositories\Doctrine\DocumentDoctrineRepository(),
            \App\Repositories\Doctrine\DocumentTypeRepository::class => new \App\Repositories\Doctrine\DocumentTypeRepository(),
            ...
            \App\Services\Doctrine\DocumentInboxService::class => new \App\Services\Doctrine\DocumentInboxService(
                self::get(\App\Repositories\Doctrine\DocumentDoctrineRepository::class),
                self::get(\App\Services\Doctrine\DocumentComplianceService::class),
                self::get(\App\Services\Doctrine\DocumentAudienceResolver::class),
                self::get(\App\Repositories\Doctrine\DocumentTypeRepository::class),
                self::get(\App\Repositories\Doctrine\DocumentViewRepository::class),
                self::get(\App\Repositories\Doctrine\DocumentAcknowledgmentRepository::class),
            ),
            ...
            \App\Services\Doctrine\DoctrineNotificationService::class => new \App\Services\Doctrine\DoctrineNotificationService(
                self::get(\App\Services\Doctrine\DocumentAudienceResolver::class),
                self::get(\App\Services\Doctrine\DocumentComplianceService::class),
                self::get(\App\Repositories\Doctrine\DocumentDoctrineRepository::class),
                self::get(\App\Repositories\ForumNotificationRepository::class),
            ...
            \App\Services\Doctrine\DoctrinePublicationService::class => new \App\Services\Doctrine\DoctrinePublicationService(
                self::get(\App\Repositories\DocumentRepository::class),
                self::get(\App\Repositories\DocumentVersionRepository::class),
                self::get(\App\Repositories\Doctrine\DocumentDoctrineRepository::class),
                self::get(\App\Repositories\Doctrine\DocumentTypeRepository::class),
                ...
                self::get(\App\Services\Doctrine\DoctrineNotificationService::class),
                self::get(\App\Repositories\UnitRepository::class),
                self::get(\App\Services\Audit\AuditService::class),
                self::get(\App\Repositories\DocumentAuditRepository::class),
            ),
            ...
            \App\Controllers\Admin\Organization\AdminDoctrineController::class => new \App\Controllers\Admin\Organization\AdminDoctrineController(
                ...
                self::get(UserRepository::class),
                self::get(\App\Repositories\Doctrine\DocumentTypeRepository::class),
                self::get(\App\Services\Doctrine\DoctrinePublicationService::class),
                self::get(\App\Services\Doctrine\DoctrineNotificationService::class),
                self::get(\App\Repositories\Doctrine\DocumentAudienceRepository::class),
                self::get(\App\Repositories\DocumentRepository::class),
                self::get(\App\Repositories\UnitRepository::class),
            ...
            \App\Services\Calendar\IcalendarService::class => new \App\Services\Calendar\IcalendarService(),
            \App\Repositories\MemberIntegrationTemplateRepository::class => new \App\Repositories\MemberIntegrationTemplateRepository(),
            \App\Repositories\MemberIntegrationRepository::class => new \App\Repositories\MemberIntegrationRepository(),
            \App\Repositories\MemberIntegrationAppointmentRepository::class => new \App\Repositories\MemberIntegrationAppointmentRepository(),
            \App\Services\MemberIntegration\MemberIntegrationProgressService::class => new \App\Services\MemberIntegration\MemberIntegrationProgressService(),
            \App\Services\MemberIntegration\MemberIntegrationService::class => new \App\Services\MemberIntegration\MemberIntegrationService(
                self::get(\App\Repositories\MemberIntegrationRepository::class),
                self::get(\App\Repositories\MemberIntegrationTemplateRepository::class),
                self::get(\App\Repositories\MemberIntegrationAppointmentRepository::class),
                self::get(\App\Services\MemberIntegration\MemberIntegrationProgressService::class),
                self::get(UserRepository::class),
                self::get(\App\Repositories\UserProfileRepository::class),
                self::get(\App\Services\Personnel\PersonnelCompletenessService::class),
                self::get(\App\Repositories\PersonnelExtrasRepository::class),
            ...
            \App\Services\MemberIntegration\MemberIntegrationInvitationService::class => new \App\Services\MemberIntegration\MemberIntegrationInvitationService(
                self::get(\App\Repositories\MemberIntegrationAppointmentRepository::class),
                self::get(\App\Repositories\MemberIntegrationRepository::class),
                self::get(UserRepository::class),
                self::get(\App\Services\Calendar\IcalendarService::class),
                self::get(\App\Services\EmailService::class),
                self::get(\App\Repositories\UserNotificationPreferencesRepository::class),
            ),
            \App\Services\MemberIntegration\MemberIntegrationAutomationService::class => new \App\Services\MemberIntegration\MemberIntegrationAutomationService(
                self::get(\App\Services\MemberIntegration\MemberIntegrationService::class),
                self::get(\App\Repositories\MemberIntegrationRepository::class),
                self::get(\App\Repositories\MemberIntegrationTemplateRepository::class),
                self::get(UserRepository::class),
                self::get(TenantRepository::class),
            ...
            \App\Services\Cron\Jobs\MemberIntegrationDailyCronJob::class => new \App\Services\Cron\Jobs\MemberIntegrationDailyCronJob(
                self::get(TenantRepository::class),
                self::get(\App\Services\MemberIntegration\MemberIntegrationAutomationService::class),
            ),
            \App\Controllers\Admin\MemberIntegrationAdminController::class => new \App\Controllers\Admin\MemberIntegrationAdminController(
                self::get(\App\Repositories\MemberIntegrationRepository::class),
                self::get(\App\Repositories\MemberIntegrationTemplateRepository::class),
                self::get(\App\Repositories\MemberIntegrationAppointmentRepository::class),
                self::get(\App\Services\MemberIntegration\MemberIntegrationService::class),
                self::get(\App\Services\MemberIntegration\MemberIntegrationInvitationService::class),
                self::get(\App\Services\MemberIntegration\MemberIntegrationAutomationService::class),
                self::get(\App\Repositories\TrainingCompetencyRepository::class),
                self::get(UserRepository::class),
                self::get(\App\Repositories\UnitRepository::class),
            ...
            \App\Controllers\Web\MemberIntegrationController::class => new \App\Controllers\Web\MemberIntegrationController(
                self::get(\App\Repositories\MemberIntegrationRepository::class),
                self::get(\App\Repositories\MemberIntegrationAppointmentRepository::class),
                self::get(\App\Services\MemberIntegration\MemberIntegrationService::class),
                self::get(\App\Services\MemberIntegration\MemberIntegrationInvitationService::class),
            ...
            \App\Controllers\Web\MemberIntegrationInvitationRespondController::class => new \App\Controllers\Web\MemberIntegrationInvitationRespondController(
                self::get(\App\Services\MemberIntegration\MemberIntegrationInvitationService::class),
                self::get(\App\Services\MemberIntegration\MemberIntegrationService::class),
                self::get(\App\Repositories\MemberIntegrationAppointmentRepository::class),
            ),
