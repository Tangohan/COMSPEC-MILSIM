...
final class ChangelogCatalog
{
    ...
    public static function releasesRaw(): array
    {
        return [
            [
                ...
                'featured' => true,
                'type' => 'major',
                'kinds' => [self::KIND_NEW, self::KIND_IMPROVED, self::KIND_FIXED],
                'categories' => ['atak', 'personnel', 'training', 'platform'],
                'status' => self::STATUS_RELEASED,
                'visibility' => 'public',
                'title_key' => 'site.cl_2026_08_portal_t',
                'summary_key' => 'site.cl_2026_08_portal_b',
                'why_key' => 'site.cl_2026_08_portal_why',
                'audiences' => [
                    'ops' => 'site.cl_2026_08_portal_ops',
                    'cmd' => 'site.cl_2026_08_portal_cmd',
                    'admin' => 'site.cl_2026_08_portal_admin',
                ],
                'feature_keys' => [
                    'site.cl_2026_08_portal_i1',
                    'site.cl_2026_08_portal_i2',
                    'site.cl_2026_08_portal_i3',
                    'site.cl_2026_08_portal_i4',
                    'site.cl_2026_08_portal_i5',
                    'site.cl_2026_08_portal_i6',
                    'site.cl_2026_08_portal_i7',
                    'site.cl_2026_08_portal_i8',
                ],
                ...
                'before_after' => null,
                'links' => [
                    ['label_key' => 'site.cl_link_training', 'href' => 'formations'],
                    ['label_key' => 'site.cl_link_integrations', 'href' => 'back-office/integrations'],
                ],
            ...
            [
                ...
                'type' => 'major',
                'kinds' => [self::KIND_NEW, self::KIND_IMPROVED, self::KIND_FIXED],
                'categories' => ['c2', 'atak', 'sse'],
                'status' => self::STATUS_RELEASED,
                'visibility' => 'public',
                'title_key' => 'site.cl_2026_08_ops_t',
                'summary_key' => 'site.cl_2026_08_ops_b',
                'why_key' => 'site.cl_2026_08_ops_why',
                'audiences' => [
                    'ops' => 'site.cl_2026_08_ops_ops',
                    'cmd' => 'site.cl_2026_08_ops_cmd',
                    'admin' => 'site.cl_2026_08_ops_admin',
                ],
                'feature_keys' => [
                    'site.cl_2026_08_ops_i1',
                    'site.cl_2026_08_ops_i2',
                    'site.cl_2026_08_ops_i3',
                    'site.cl_2026_08_ops_i4',
                    'site.cl_2026_08_ops_i5',
                    'site.cl_2026_08_ops_i6',
                    'site.cl_2026_08_ops_i7',
                ],
                'image' => 'assets/images/fog-team.jpg',
                'gallery' => [
                    ['src' => 'assets/images/night-team.jpg', 'alt_key' => 'site.cl_media_ops_alt'],
                    ['src' => 'assets/images/fog-banner.jpg', 'alt_key' => 'site.cl_media_night_alt'],
                ],
                'video' => null,
                'before_after' => null,
                'links' => [
                    ['label_key' => 'site.cl_link_hub', 'href' => 'back-office/atak'],
    ...
    private static function pipelineRaw(): array
    {
        return [
            ...
            ['title_key' => 'site.cl_pipe_terrain', 'status' => self::STATUS_TESTING],
