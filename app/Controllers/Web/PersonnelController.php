...
class PersonnelController
{
    ...
    public function update(Request $request, array $params = []): Response
    {
        ...
        $data = [
            ...
            'service_branch' => trim((string) $request->input('service_branch')) ?: null,
            'birth_place' => trim((string) $request->input('birth_place')) ?: null,
            'service_status' => trim((string) $request->input('service_status')) ?: null,
            'gendarmerie_status' => trim((string) $request->input('gendarmerie_status')) ?: null,
            'administrative_position' => trim((string) $request->input('administrative_position')) ?: null,
            'bureau_sn' => trim((string) $request->input('bureau_sn')) ?: null,
            'military_origin' => trim((string) $request->input('military_origin')) ?: null,
            'statutory_limit_date' => trim((string) $request->input('statutory_limit_date')) ?: null,
            'management_service_limit_date' => trim((string) $request->input('management_service_limit_date')) ?: null,
