...
final class AtakPhoneConnectController
{
    ...
    private function openDevice(array $params, string $view): Response
    {
        ...
        /* Shell mobile dédié — plus d’iframe desktop (embed×popout cassait l’UI téléphone). */
        $mobileModules = [
            'map' => 'sitac',
            'chat' => 'chat',
            'orders' => 'orders',
        ...
        $module = $mobileModules[$view] ?? 'c2';

        return Response::redirect(url('atak/mobile/' . $module));
    }
