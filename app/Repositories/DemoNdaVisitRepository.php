...
final class DemoNdaVisitRepository
{
    ...
    {
        // Ne pas ouvrir PDO ici : ce dépôt est résolu via le middleware global Demo NDA.
        // Une connexion eager ferait échouer /api/atak/* dès le boot Container si la BDD
        // est briefly injoignable — alors que ces routes n’utilisent pas Demo NDA.
        $this->pdo = $pdo;
    }
