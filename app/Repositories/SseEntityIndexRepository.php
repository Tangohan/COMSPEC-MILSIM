...
final class SseEntityIndexRepository
{
    ...
    private function hydrate(array $row): array
    {
        ...
        return [
            ...
            'entity_type_label' => \App\Support\SseWorkspaceUi::entityTypeLabel((string) ($row['entity_type'] ?? '')),
            'icon' => \App\Support\SseWorkspaceUi::iconForEntityType((string) ($row['entity_type'] ?? '')),
