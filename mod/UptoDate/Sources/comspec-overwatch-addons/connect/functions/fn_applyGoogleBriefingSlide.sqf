/*
    ...
    Applique une texture au briefing ATAK, au dialog 9970 (repli) et aux écrans Eden.
...
if (!isNil "comspec_overwatch_atak_athena_fnc_athena_applyBriefingSlide") then {

    [_path, _title, _index, _total] call comspec_overwatch_atak_athena_fnc_athena_applyBriefingSlide;

} else {

    // Repli si addon athena absent
