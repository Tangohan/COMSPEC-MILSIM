...
if (_lang isEqualTo "en") exitWith {
    [
        ...
        "<t size='0.72' color='#c8d8e4'>" +
            ...
            "Found something wrong? In game, use the ACE self-interaction menu → <t color='#e8f4f0'>Report a problem</t>. Describe what happened and when. Reports go to the team that maintains the pack.<br/><br/>" +
...
[
    ...
    "<t size='0.72' color='#c8d8e4'>" +
        ...
        "Un bug, un gel, un comportement bizarre ? En jeu, menu d’interaction ACE → <t color='#e8f4f0'>Signaler un problème</t>. Décrivez ce qui s’est passé. Les signalements arrivent à l’équipe qui suit le pack.<br/><br/>" +
