/*
    ACE createAction renvoie _this. Sans 11 cases, collectActiveActionTree
    plante sur select 10. Un seul pushBack {} ne suffit pas (6 → 7, toujours court).
    [_action] call comspec_overwatch_connect_fnc_acePadAction
*/
params [
    ["_act", [], [[]]]
];
