/*
    Ouvre Manifeste de vol depuis le tiroir.
*/
...
[] spawn {
    ...
    ["AtakManifest"] call comspec_overwatch_atak_athena_fnc_athena_openAtakApp;
    uiSleep 0.12;
    if (isNull (uiNamespace getVariable ["COMSPEC_ATAK_Manifest_group", controlNull])) then {
        ["cTab_Android_dlg", [["showMenu", ["AtakManifest", true, ["", -1], createHashMap]]], true, true] call cTab_fnc_setSettings;
    };
};
