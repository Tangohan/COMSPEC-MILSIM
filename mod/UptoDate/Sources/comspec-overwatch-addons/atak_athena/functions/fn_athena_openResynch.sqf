/*
    Ouvre l’app Resynch dans ATAK Enhanced (tiroir d’applications).
*/
...
[] spawn {
    ...
    ["AtakResynch"] call comspec_overwatch_atak_athena_fnc_athena_openAtakApp;
    uiSleep 0.15;
    if (isNull (uiNamespace getVariable ["COMSPEC_ATAK_Resynch_group", controlNull])) then {
        ["cTab_Android_dlg", [["showMenu", ["AtakResynch", true, ["", -1], createHashMap]]], true, true] call cTab_fnc_setSettings;
        uiSleep 0.12;
    };
};
