/*
    Ouvre Reco dans le tiroir du téléphone (comme Relais AT / Appui aérien).
*/
...
[] spawn {
    ...
    ["AtakRecon"] call comspec_overwatch_atak_athena_fnc_athena_openAtakApp;
    uiSleep 0.12;
    if (isNull (uiNamespace getVariable ["COMSPEC_ATAK_Recon_group", controlNull])) then {
        ["cTab_Android_dlg", [["showMenu", ["AtakRecon", true, ["", -1], createHashMap]]], true, true] call cTab_fnc_setSettings;
    };
};
