...
[
    "COMSPEC_ATAK_playtime_enabled",
    "CHECKBOX",
    ["Temps en mission", "Envoie au poste le temps passé en serveur, en Zeus et dans l’éditeur, affiché ensuite sur le tableau de bord et la fiche. Désactivez si vous ne souhaitez pas ce suivi."],
    ["COMSPEC ATAK", "Liaison Athena"],
    true,
    0
] call CBA_fnc_addSetting;
