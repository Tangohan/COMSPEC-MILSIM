...
class cTab_Tablet_dlg
{
	...
	class controls
	{
		...
		class MainSubmenu: cTab_RscControlsGroup
		{
			...
			y="safeZoneY + safeZoneH - ((4 + 0.5) * (27) / 2048  *  ( (safezoneW * 0.8) * 4/3) / 0.8) - 0.07";
...
class RscTitles
{
	...
	class cTab_android_RscMapControl: cTab_RscMapControl
	{
		idc=1201;
		text="#(argb,8,8,3)color(1,1,1,1)";
		x="(((452))) / 2048  *  (0.86) +  (safezoneX + (safezoneW -  (0.86)) / 2)";
	...
	class cTab_android_btnBack: cTab_RscButtonInv
	{
		x="(1550) / 2048  *  (0.86) +  (safezoneX + (safezoneW -  (0.86)) / 2)";
	...
	class cTab_android_btnPower: cTab_RscButtonInv
	{
		x="(1583) / 2048  *  (0.86) +  (safezoneX + (safezoneW -  (0.86)) / 2)";
	...
	class cTab_android_notificationLight
	{
		x="(360) / 2048  *  (0.86) +  (safezoneX + (safezoneW -  (0.86)) / 2)";
	...
	class cTab_android_on_screen_battery: cTab_RscPicture
	{
		idc=2;
		text="\cTab\img\icon_battery_ca.paa";
		x="((((20) + (452)) + ((20) + (((1098) - (20) * 6) / 5)) * (1 - 1))) / 2048  *  (0.86) +  (safezoneX + (safezoneW -  (0.86)) / 2)";
	...
	class cTab_android_on_screen_time: cTab_RscText_Android
	{
		idc=2613;
		style=2;
		x="((((20) + (452)) + ((20) + (((1098) - (20) * 6) / 5)) * (3 - 1))) / 2048  *  (0.86) +  (safezoneX + (safezoneW -  (0.86)) / 2)";
	...
	class cTab_android_on_screen_signalStrength: cTab_android_on_screen_battery
	{
		idc=3;
		text="\cTab\img\icon_signalStrength_ca.paa";
		x="((((20) + (452)) + ((20) + (((1098) - (20) * 6) / 5)) * (5 - 1)) + (((1098) - (20) * 6) / 5) - (42) * 2) / 2048  *  (0.86) +  (safezoneX + (safezoneW -  (0.86)) / 2)";
		colorText[]={1,1,1,1};
	};
	class cTab_android_on_screen_satellite: cTab_android_on_screen_battery
	{
		idc=4;
		text="\a3\ui_f\data\map\Diary\signal_ca.paa";
		x="((((20) + (452)) + ((20) + (((1098) - (20) * 6) / 5)) * (5 - 1)) + (((1098) - (20) * 6) / 5) - (42)) / 2048  *  (0.86) +  (safezoneX + (safezoneW -  (0.86)) / 2)";
		colorText[]={1,1,1,1};
	};
	class cTab_android_on_screen_dirDegree: cTab_android_on_screen_time
	{
		idc=2615;
		style=0;
		x="((((20) + (452)) + ((20) + (((1098) - (20) * 6) / 5)) * (2 - 1))) / 2048  *  (0.86) +  (safezoneX + (safezoneW -  (0.86)) / 2)";
	};
	class cTab_android_on_screen_grid: cTab_android_on_screen_dirDegree
	{
		idc=2612;
		style=1;
		x="((((20) + (452)) + ((20) + (((1098) - (20) * 6) / 5)) * (4 - 1))) / 2048  *  (0.86) +  (safezoneX + (safezoneW -  (0.86)) / 2)";
	};
	class cTab_android_on_screen_dirOctant: cTab_android_on_screen_dirDegree
	{
		idc=2616;
	...
	class cTab_android_movingHandle_T: cTab_RscText_Android
	{
		...
		moving=1;
		colorBackground[]={0,0,0,0};
		x="(0) / 2048  *  (0.86) +  (safezoneX + (safezoneW -  (0.86)) / 2)";
	...
	{
		idc=8;
		x="((452) + (1098)) / 2048  *  (0.86) +  (safezoneX + (safezoneW -  (0.86)) / 2)";
	...
	{
		idc=1620;
		x="(((452)) + (((1098)) * 0.2) / 2) / 2048  *  (0.86) +  (safezoneX + (safezoneW -  (0.86)) / 2)";
