// Indicatif + rôle tactique (idd 9977 — distinct de la tablette 9974)
class COMSPEC_Callsign_Dialog {
    ...
    class Controls {
        ...
        class Title: RscStructuredText {
            idc = -1;
            text = "<t font='RobotoCondensedBold' size='1' align='center' color='#e8f4f0'>Mon identité tactique</t>";
        ...
        class LabelCs: RscStructuredText {
            idc = -1;
            text = "<t size='0.55' color='#5a9e88'>INDICATIF</t>";
            x = 0.36 * safezoneW + safezoneX;
        ...
        class LabelRole: RscStructuredText {
            idc = -1;
            text = "<t size='0.55' color='#5a9e88'>RÔLE</t>";
            x = 0.36 * safezoneW + safezoneX;
