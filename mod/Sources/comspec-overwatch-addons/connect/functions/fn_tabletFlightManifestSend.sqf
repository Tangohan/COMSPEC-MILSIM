...
[format ["[FLIGHT MANIFEST] Sent (tablet): %1", _callsign]] call comspec_overwatch_connect_fnc_appendLinkLog;
["Manifest de vol transmis.", "system", "info"] call comspec_overwatch_connect_fnc_announce;
