...
private _json = format [
    '{"type":"FLIGHT_MANIFEST","callsign":"%1","model":"%2","aircraft_type":"%3","freq":"%4","laser":"%5","auth":"%6","alt":%7,"heading":%8,"pos":[%9,%10],"side":"%11","aircraft_count":%12}',
    _callsignEsc, _modelEsc, _aircraftType, _freqEsc, _laserEsc, _authEsc,
    _alt, _heading, _posX, _posY, _sideStr, _count
];
