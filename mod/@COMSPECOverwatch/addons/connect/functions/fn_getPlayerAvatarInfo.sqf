/*
    Demande le profil site (nom, callsign, photo, unité, identifiant ATAK) du joueur courant à la
    plateforme (extension native, fonction GetPlayerAvatarInfo), identifié par son SteamUID.

    Retourne : [displayName, callsign, avatarUrl, unitName, atakId] ou [] en cas d'échec
    (compte non lié, etc.).
*/
