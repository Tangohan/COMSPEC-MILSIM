...
class COMSPEC_AccountLink_Dialog {
    ...
    class Controls {
        ...
        class Hint: RscStructuredText {
            idc = -1;
            text = "<t align='center' size='0.62' color='#8aa0b4'>Sur Athena, ouvrez ATAK → bouton Connexion en jeu → Générer un code. Saisissez-le ici (valable 30 min, usage unique).</t>";
            x = 0.34 * safezoneW + safezoneX;
