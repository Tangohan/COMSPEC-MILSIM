...
private _fnc_notifyPath = {
    ...
    // JPEG IceMan : c’est le fichier qui part au poste. Ne pas le remplacer par un PNG Arma.
...
// Chemin fourni (IceMan / BCE / Photo Library). Un JPEG part tel quel au poste.
// Pas de PNG Arma de substitution : c’est ça qui relançait la rafale.
