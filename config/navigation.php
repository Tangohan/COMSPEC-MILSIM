            ...
            'sections' => [
                ...
                [
                    ...
                    'links' => [
                        ...
                        ['label' => 'Bureau effectifs', 'path' => 'back-office/ressources/effectifs', 'any_permissions' => ['organization.effectifs.hub.view', 'personnel.profile.update', 'personnel.assignments.manage', 'personnel.grades.manage', 'personnel.status.manage', 'admin.organization', 'admin.access'], 'description' => 'Tableur RH : rôles, fonctions, affectations'],
                        ...
                        ['label' => 'Organisation des effectifs', 'path' => 'back-office/organisation-effectifs', 'any_permissions' => ['admin.organization', 'admin.access'], 'description' => 'Vue d’ensemble : rôles, grades et structure'],
                    ],
                ],
            ],
            'live' => [
            ...
            'sections' => [
                ...
                [
                    ...
                    'links' => [
                        ...
                        ['label' => 'Bureau effectifs', 'path' => 'back-office/ressources/effectifs', 'any_permissions' => ['organization.effectifs.hub.view', 'personnel.profile.update', 'personnel.assignments.manage', 'personnel.grades.manage', 'personnel.status.manage', 'admin.organization', 'admin.access'], 'description' => 'Tableur RH et pilotage des effectifs'],
