            ...
            'sections' => [
                ...
                [
                    ...
                    'links' => [
                        ...
                        ['label' => 'Feedback post-leçon', 'path' => 'back-office/ressources/training/feedback', 'any_permissions' => ['admin.access', 'training.manage', 'training.assign', 'training.create', 'training.update', 'training.publish', 'training.delete'], 'description' => 'Retours apprenants : difficulté, clarté, utilité'],
