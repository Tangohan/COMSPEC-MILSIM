            ...
            'sections' => [
                ...
                [
                    ...
                    'links' => [
                        ...
                        ['label' => 'Réseau de relais', 'path' => 'back-office/atak/relays-network', 'description' => 'Mâts Relais du théâtre : état, portée et places', 'any_permissions' => ['admin.system', 'admin.organization', 'admin.access']],
                        ['label' => 'Mode roleplay ATAK', 'path' => 'back-office/atak/roleplay', 'description' => 'Liaison dégradée, zones et données chiffrées', 'any_permissions' => ['admin.system', 'admin.organization', 'admin.access']],
            ...
            'sections' => [
                ...
                [
                    ...
                    'links' => [
                        ...
                        ['label' => 'Organisation', 'path' => 'back-office/organisation-effectifs', 'any_permissions' => ['admin.organization', 'admin.access'], 'description' => 'Organigramme, grades et catalogue (distinct du tableur Effectifs)'],
                    ],
                ],
            ],
            'live' => [
            ...
            'sections' => [
                [
                    ...
                    'links' => [
                        ...
                        ['label' => 'Comptes utilisateurs (site)', 'path' => 'admin/users', 'permission' => 'admin.system', 'description' => 'Annuaire des comptes, activation et désactivation'],
                        ['label' => 'Administrateurs du site', 'path' => 'admin/system/administrateurs-site', 'permission' => 'admin.system', 'description' => 'Liste fermée des personnes qui tiennent la plateforme'],
                        ...
                        ['label' => 'Accès démo du site', 'path' => 'admin/system/demo-nda', 'permission' => 'admin.system', 'description' => 'Code, durées et adresses autorisées pour la démonstration'],
                        ['label' => 'Outils du portail candidatures', 'path' => 'admin/system/recruitment-portal-tools', 'permission' => 'admin.system', 'description' => 'Filtres, relances et accès exceptionnels'],
                        ['label' => 'Types de coopération', 'path' => 'admin/system/cooperation/catalog', 'permission' => 'admin.system', 'description' => 'Référence des formats d’échange entre unités'],
                        ['label' => 'Annonces de coopération', 'path' => 'admin/system/cooperation/announcements', 'permission' => 'admin.system', 'description' => 'Textes par défaut pour les coopérations'],
                        ['label' => 'Référentiel militaire', 'path' => 'admin/system/military-referential', 'permission' => 'admin.system', 'description' => 'Unités et affiliations de référence'],
                        ['label' => 'Rôles système', 'path' => 'admin/roles', 'permission' => 'admin.system'],
                        ['label' => 'Rôles site (affectations)', 'path' => 'admin/site-roles', 'permission' => 'admin.system', 'description' => 'Assistance et modération : l’administration du site se gère dans la liste fermée'],
                        ['label' => 'Édition avancée de fiche', 'path' => 'admin/system/advanced-fiche-edit', 'permission' => 'admin.system', 'description' => 'Autoriser une modification exceptionnelle d’une fiche'],
                        ...
                        ['label' => 'Maintenance des données', 'path' => 'admin/maintenance', 'permission' => 'admin.system'],
                        ...
                        ['label' => 'Journal d’audit', 'path' => 'admin/audit', 'permission' => 'admin.system'],
                ...
                [
                    ...
                    'links' => [
                        ...
                        ['label' => 'Réseau de relais', 'path' => 'back-office/atak/relays-network', 'any_permissions' => ['admin.system', 'admin.organization', 'admin.access'], 'description' => 'Mâts Relais du théâtre : état, portée et places'],
                        ['label' => 'Mode roleplay ATAK', 'path' => 'back-office/atak/roleplay', 'any_permissions' => ['admin.system', 'admin.organization', 'admin.access'], 'description' => 'Liaison dégradée, zones et données chiffrées'],
                        ['label' => 'Poste ATAK', 'path' => 'back-office/atak', 'any_permissions' => ['admin.system', 'admin.organization', 'admin.access'], 'description' => 'Dossiers SSE identifiés et localisation téléphone'],
                        ['label' => 'Effectifs en liaison', 'path' => 'back-office/atak/operateurs', 'any_permissions' => ['admin.system', 'admin.organization', 'admin.access'], 'description' => 'Tableur des opérateurs connectés'],
                ...
                [
                    ...
                    'links' => [
                        ...
                        ['label' => 'Mur opérationnel', 'path' => 'tableau-operationnel', 'permission' => 'operational.board.view', 'description' => 'Permanences et consignes publiées'],
                        ['label' => 'Pilotage du mur opérationnel', 'path' => 'back-office/tableau-operationnel', 'any_permissions' => ['operational.board.edit', 'admin.organization', 'admin.access', 'admin.system'], 'description' => 'Événements, articles, ATAK et mur de consignes'],
                        ...
                        ['label' => 'Paramètres de la communauté', 'path' => 'back-office/community', 'any_permissions' => ['admin.organization', 'admin.access'], 'description' => 'Identité, vitrine, inscription, accueil et profil'],
                        ...
                        ['label' => 'Intégration des nouveaux membres', 'path' => 'back-office/integration-membres', 'any_permissions' => ['member_integration.view', 'member_integration.manage', 'member_integration.assign', 'admin.organization', 'admin.access'], 'description' => 'Parcours d’arrivée, référents, rendez-vous et dossier personnel'],
                        ...
                        ['label' => 'Parcours d’immersion', 'path' => 'back-office/roleplay/immersion', 'any_permissions' => ['admin.organization', 'admin.access'], 'description' => 'Étapes, filières et indicateur « dossier prêt » du suivi d’arrivée'],
                        ['label' => 'Parcours RH', 'path' => 'back-office/roleplay/regles-phases', 'any_permissions' => ['admin.organization', 'admin.access'], 'description' => 'Étapes du parcours et conditions de passage à l’étape suivante'],
                        ['label' => 'Sessions Arma', 'path' => 'back-office/roleplay/sessions', 'any_permissions' => ['admin.organization', 'admin.access'], 'description' => 'Types de sessions, pointage et temps retenu pour le suivi'],
                        ['label' => 'Bureau effectifs', 'path' => 'back-office/ressources/effectifs', 'any_permissions' => ['organization.effectifs.hub.view', 'personnel.profile.update', 'personnel.assignments.manage', 'personnel.grades.manage', 'personnel.status.manage', 'admin.organization', 'admin.access'], 'description' => 'Tableur RH nominatif : profils, statuts, affectations, élévations'],
                        ['label' => 'Organisation', 'path' => 'back-office/organisation-effectifs', 'any_permissions' => ['admin.organization', 'admin.access'], 'description' => 'Organigramme, grades et catalogue (distinct du tableur Effectifs)'],
                        ['label' => 'Accès', 'path' => 'back-office/ressources/effectifs/roles', 'any_permissions' => ['admin.organization', 'admin.access', 'admin.roles.manage'], 'description' => 'Corriger ce qu’un niveau a le droit de faire, comme un rôle Discord'],
                        ['label' => 'Emplois', 'path' => 'back-office/ressources/effectifs/fonctions', 'any_permissions' => ['admin.organization', 'admin.access', 'personnel.assignments.manage'], 'description' => 'Libellés du dossier, distincts des niveaux d’accès'],
                        ['label' => 'Raccourcis dashboard', 'path' => 'back-office/dashboard-pins', 'any_permissions' => ['dashboard.pins.manage', 'admin.organization', 'admin.access']],
                        ['label' => 'Tenues du tableau de bord', 'path' => 'back-office/dashboard-tenues', 'any_permissions' => ['dashboard.pins.manage', 'admin.organization', 'admin.access'], 'description' => 'Vitrine de tenues, PNG de personnage'],
                        ...
                        ['label' => 'Intégrations externes', 'path' => 'back-office/integrations', 'any_permissions' => ['admin.organization', 'admin.access'], 'description' => 'Relais Discord (salon commun, salons à part, photos Quick Picture) et jetons d’accès'],
