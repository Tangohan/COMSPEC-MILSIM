...
return [
    'pages' => [
        ...
        ['path' => 'back-office/missions', 'group' => 'Opérations', 'kicker' => 'OPÉRATIONS · PORTAIL', 'title' => 'Portail missions', 'subtitle' => 'Missions, participants, communications ATAK et liaisons — vue d’ensemble pour le poste.', 'css' => ['back-office-missions-portal.css'], 'quick' => [
        ...
        ['path' => 'documents/gestion/ajout', 'group' => 'Ressources', 'kicker' => 'RESSOURCES · DOCUMENTS', 'title' => 'Nouveau document', 'subtitle' => 'Joindre un fichier ou rédiger un manuel avec page de garde.', 'css' => ['document-fm.css']],
        ['path' => 'documents/gestion', 'group' => 'Ressources', 'kicker' => 'RESSOURCES · DOCUMENTS', 'title' => 'Bibliothèque documentaire', 'css' => ['document-fm.css']],
