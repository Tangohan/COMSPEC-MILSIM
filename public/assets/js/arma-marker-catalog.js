...
window.ArmaMarkerCatalog = (function () {
  ...
  var ENTRIES = {
    ...
    'b_inf': { kind: 'nato', label: 'Infanterie amie', affiliation: 'friend', role: 'inf', source: 'vanilla' },
    'o_inf': { kind: 'nato', label: 'Infanterie hostile', affiliation: 'hostile', role: 'inf', source: 'vanilla' },
    'n_inf': { kind: 'nato', label: 'Infanterie inconnue', affiliation: 'neutral', role: 'inf', source: 'vanilla' },
    ...
    'b_mech_inf': { kind: 'nato', label: 'Infanterie mécanisée amie', affiliation: 'friend', role: 'mech_inf', source: 'vanilla' },
    'o_mech_inf': { kind: 'nato', label: 'Infanterie mécanisée hostile', affiliation: 'hostile', role: 'mech_inf', source: 'vanilla' },
    'n_mech_inf': { kind: 'nato', label: 'Infanterie mécanisée inconnue', affiliation: 'neutral', role: 'mech_inf', source: 'vanilla' },
    ...
    'b_motor_inf': { kind: 'nato', label: 'Infanterie motorisée amie', affiliation: 'friend', role: 'motor_inf', source: 'vanilla' },
    'o_motor_inf': { kind: 'nato', label: 'Infanterie motorisée hostile', affiliation: 'hostile', role: 'motor_inf', source: 'vanilla' },
    ...
    'b_armor': { kind: 'nato', label: 'Blindé ami', affiliation: 'friend', role: 'armor', source: 'vanilla' },
    'o_armor': { kind: 'nato', label: 'Blindé hostile', affiliation: 'hostile', role: 'armor', source: 'vanilla' },
    'n_armor': { kind: 'nato', label: 'Blindé inconnu', affiliation: 'neutral', role: 'armor', source: 'vanilla' },
    ...
    'b_recon': { kind: 'nato', label: 'Reconnaissance amie', affiliation: 'friend', role: 'recon', source: 'vanilla' },
    'o_recon': { kind: 'nato', label: 'Reconnaissance hostile', affiliation: 'hostile', role: 'recon', source: 'vanilla' },
    'n_recon': { kind: 'nato', label: 'Reconnaissance inconnue', affiliation: 'neutral', role: 'recon', source: 'vanilla' },
    ...
    'b_air': { kind: 'nato', label: 'Hélicoptère ami', affiliation: 'friend', role: 'air', source: 'vanilla' },
    'o_air': { kind: 'nato', label: 'Hélicoptère hostile', affiliation: 'hostile', role: 'air', source: 'vanilla' },
