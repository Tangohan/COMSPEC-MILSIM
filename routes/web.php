...
return function (Router $router) {
    ...
    $router->get('/admin/organization/invitations', [InvitationAdminController::class, 'index'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    ...
    $router->get('/admin/organization/events', [CommunityEventsAdminController::class, 'index'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/admin/organization/events', [CommunityEventsAdminController::class, 'store'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
