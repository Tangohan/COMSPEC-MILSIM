...
return function (Router $router) {
    ...
    $router->post('/back-office/moderation/blocklist/add', [ModerationOrganizationController::class, 'blocklistAdd'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/moderation/blocklist/revoke', [ModerationOrganizationController::class, 'blocklistRevoke'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    ...
    $router->post('/admin/training/courses/{id}/showcase', [AdminTrainingController::class, 'courseShowcase'], $lmsAdminMw);
    ...
    $router->post('/admin/training/enrollments/{id}/approve', [AdminTrainingController::class, 'approveEnrollment'], $lmsAdminMw);
    ...
    $router->post('/admin/training/studio', [AdminTrainingStudioController::class, 'store'], $studioMw);
    $router->post('/admin/training/studio/{id}', [AdminTrainingStudioController::class, 'handle'], $studioMw);
    ...
    $router->get('/admin/interteam-missions', [InterteamMissionWebController::class, 'index'], $interteamMw);
    $router->get('/admin/interteam-missions/create', [InterteamMissionWebController::class, 'create'], $interteamMw);
    $router->post('/admin/interteam-missions', [InterteamMissionWebController::class, 'store'], $interteamMw);
    $router->get('/admin/interteam-missions/{id}', [InterteamMissionWebController::class, 'show'], $interteamMw);
    ...
    $trainingResMw = [AuthMiddleware::class, NonDefaultTenantMiddleware::class];
    ...
    $router->get('/back-office/ressources/interteam-missions', fn (\App\Core\Request $r, array $p) => \App\Core\Response::redirect(url('admin/interteam-missions')), $interteamMw);
    $router->get('/back-office/ressources/interteam-missions/create', fn (\App\Core\Request $r, array $p) => \App\Core\Response::redirect(url('admin/interteam-missions/create')), $interteamMw);
    $router->get('/back-office/ressources/interteam-missions/{id}', fn (\App\Core\Request $r, array $p) => \App\Core\Response::redirect(url('admin/interteam-missions/' . ($p['id'] ?? ''))), $interteamMw);
