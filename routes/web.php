...
return function (Router $router) {
    ...
    $router->post('/formations/enroll', [TrainingController::class, 'postEnroll'], [AuthMiddleware::class]);
    $router->post('/formations/favorite', [TrainingController::class, 'postFavorite'], [AuthMiddleware::class]);
    $router->post('/formations/review', [TrainingController::class, 'postReview'], [AuthMiddleware::class]);
    $router->post('/formations/question', [TrainingController::class, 'postQuestion'], [AuthMiddleware::class]);
    $router->post('/formations/comment', [TrainingController::class, 'postComment'], [AuthMiddleware::class]);
    $router->get('/formations/mes-formations', [TrainingController::class, 'myTraining'], [AuthMiddleware::class]);
    $router->get('/formations/code-acces', [TrainingController::class, 'accessCodeForm'], [AuthMiddleware::class]);
    $router->post('/formations/code-acces', [TrainingController::class, 'accessCodeSubmit'], [AuthMiddleware::class]);
    /** Doit rester avant /formations/{slug} pour que « …/echanges » ne soit pas confondu avec un slug. */
    $router->get('/formations/{slug}/echanges', [TrainingController::class, 'courseExchanges'], [AuthMiddleware::class]);
    $router->get('/formations/lesson/{id}', [TrainingController::class, 'lesson'], [AuthMiddleware::class]);
    $router->post('/formations/quiz/start', [TrainingController::class, 'startQuiz'], [AuthMiddleware::class]);
    ...
    $router->post('/admin/training/enrollments/{id}/approve', [AdminTrainingController::class, 'approveEnrollment'], [AuthMiddleware::class, NonDefaultTenantMiddleware::class]);
    $router->post('/admin/training/enrollments/{id}/decline', [AdminTrainingController::class, 'declineEnrollment'], [AuthMiddleware::class, NonDefaultTenantMiddleware::class]);
    ...
    $router->get('/back-office/ressources/training/courses/{id}/showcase', fn (\App\Core\Request $r, array $p) => \App\Core\Response::redirect(url('admin/training/courses/' . ($p['id'] ?? '') . '/showcase')), $trainingResMw);
    $router->get('/back-office/ressources/training/courses', fn (\App\Core\Request $r, array $p) => \App\Core\Response::redirect(url('admin/training/courses')), $trainingResMw);
    $router->get('/back-office/ressources/training/enrollments', fn (\App\Core\Request $r, array $p) => \App\Core\Response::redirect(url('admin/training/enrollments')), $trainingResMw);
    $router->get('/back-office/ressources/training/reports', fn (\App\Core\Request $r, array $p) => \App\Core\Response::redirect(url('admin/training/reports')), $trainingResMw);
    $router->get('/back-office/ressources/training/certificates', fn (\App\Core\Request $r, array $p) => \App\Core\Response::redirect(url('admin/training/certificates')), $trainingResMw);
    $router->get('/back-office/ressources/training/audit', fn (\App\Core\Request $r, array $p) => \App\Core\Response::redirect(url('admin/training/audit')), $trainingResMw);
    $router->get('/back-office/ressources/training', fn (\App\Core\Request $r, array $p) => \App\Core\Response::redirect(url('admin/training')), $trainingResMw);
    ...
    $router->get('/api/training/progress/lesson', fn (\App\Core\Request $r, array $p) => \App\Core\Response::redirect(url('formations')), [AuthMiddleware::class]);
    $router->post('/api/training/progress/lesson', [TrainingApiController::class, 'progressLesson'], [AuthMiddleware::class]);
    $router->get('/api/training/resource/{id}/download', [TrainingApiController::class, 'lessonResourceDownload'], [AuthMiddleware::class]);
