...
use App\Controllers\Web\SseIntelligenceWorkspaceController;
...
use App\Controllers\Admin\AdminAtakHubController;
...
use App\Controllers\Admin\LegacyPersonnelRedirectController;
use App\Controllers\Admin\RhDossierWorkspaceController;
...
use App\Controllers\Admin\System\SystemStorageController;
...
use App\Controllers\Admin\MemberIntegrationAdminController;
use App\Controllers\Web\MemberIntegrationController;
use App\Controllers\Web\MemberIntegrationInvitationRespondController;
...
use App\Controllers\Admin\Organization\OrganizationCatalogController;
...
use App\Middleware\SseConfidentialityMiddleware;
...
return function (Router $router) {
    ...
    $mwSseClearance = [SsePortalAccessMiddleware::class];
    $mwSsePortal = [SsePortalAccessMiddleware::class, SseConfidentialityMiddleware::class];
    ...
    $router->get('/integration/invitation/repondre', [MemberIntegrationInvitationRespondController::class, 'show']);
    $router->post('/integration/invitation/repondre', [MemberIntegrationInvitationRespondController::class, 'submit']);
    $router->get('/integration/invitation/calendrier', [MemberIntegrationInvitationRespondController::class, 'calendar']);
    ...
    $router->get('/jnet/operations/{id}', [JnetPortalController::class, 'operationShow'], [AuthMiddleware::class]);
    $router->get('/jnet/renseignement', [JnetPortalController::class, 'intelligence'], [AuthMiddleware::class]);
    $router->get('/jnet/cibles', [JnetPortalController::class, 'targets'], [AuthMiddleware::class]);
    $router->get('/jnet/cibles/{id}', [JnetPortalController::class, 'targetShow'], [AuthMiddleware::class]);
    ...
    $router->get('/jnet/sync', [JnetPortalController::class, 'sync'], [AuthMiddleware::class]);
    $router->get('/jnet/theatre', [JnetPortalController::class, 'theatre'], [AuthMiddleware::class]);
    $router->get('/jnet/sources', [JnetPortalController::class, 'sources'], [AuthMiddleware::class]);
    $router->get('/jnet/intentions', [JnetPortalController::class, 'intents'], [AuthMiddleware::class]);
    ...
    $router->post('/onboarding/step', [OnboardingController::class, 'toggleStep'], [AuthMiddleware::class]);
    ...
    $router->post('/admin/system/advanced-fiche-edit/{id}/revoke', [\App\Controllers\Web\AdvancedFicheEditGrantController::class, 'revoke'], [AuthMiddleware::class, SystemAdminMiddleware::class]);
    /* Ancienne URL back-office → admin plateforme */
    $router->get('/back-office/personnel/advanced-edit', fn (\App\Core\Request $r, array $p) => \App\Core\Response::redirect(url('admin/system/advanced-fiche-edit')), [AuthMiddleware::class]);
    $router->post('/back-office/personnel/advanced-edit/grant', fn (\App\Core\Request $r, array $p) => \App\Core\Response::redirect(url('admin/system/advanced-fiche-edit')), [AuthMiddleware::class]);
    $router->post('/back-office/personnel/advanced-edit/{id}/revoke', fn (\App\Core\Request $r, array $p) => \App\Core\Response::redirect(url('admin/system/advanced-fiche-edit')), [AuthMiddleware::class]);
    ...
    $router->post('/personnel/{id}/visibility', [PersonnelController::class, 'updateVisibility'], [AuthMiddleware::class]);
    ...
    $router->get('/atak/sse/confidentialite', [SsePortalController::class, 'confidentiality'], $mwSseClearance);
    $router->post('/atak/sse/confidentialite', [SsePortalController::class, 'confidentialityAccept'], $mwSseClearance);
    ...
    $router->post('/atak/sse/workspace/dossiers/{id}/meta', [SseIntelligenceWorkspaceController::class, 'caseMetaUpdate'], $mwSsePortal);
    $router->post('/atak/sse/workspace/cycle/exigences', [SseIntelligenceWorkspaceController::class, 'cycleRequirementStore'], $mwSsePortal);
    $router->post('/atak/sse/workspace/cycle/ordres', [SseIntelligenceWorkspaceController::class, 'cycleTaskingStore'], $mwSsePortal);
    $router->post('/atak/sse/workspace/cycle/produits/generer', [SseIntelligenceWorkspaceController::class, 'cycleProductGenerate'], $mwSsePortal);
    $router->post('/atak/sse/workspace/cycle/produits/{id}', [SseIntelligenceWorkspaceController::class, 'cycleProductAction'], $mwSsePortal);
    $router->post('/atak/sse/workspace/analyse/constats/{id}', [SseIntelligenceWorkspaceController::class, 'analysisFindingDecide'], $mwSsePortal);
    ...
    $router->get('/atak/sse/documents', [SsePortalController::class, 'documentsIndex'], $mwSsePortal);
    $router->get('/atak/sse/documents/nouveau', [SsePortalController::class, 'documentCreateForm'], $mwSsePortal);
    $router->post('/atak/sse/documents', [SsePortalController::class, 'documentStore'], $mwSsePortal);
    $router->get('/atak/sse/documents/{id}', [SsePortalController::class, 'documentShow'], $mwSsePortal);
    ...
    $router->get('/atak/sse/transmissions/pdf', [SsePortalController::class, 'transmissionsPdf'], $mwSsePortal);
    $router->post('/atak/sse/transmissions/relais', [SsePortalController::class, 'transmissionDiscordStore'], $mwSsePortal);
    $router->post('/atak/sse/transmissions/relais/communaute', [SsePortalController::class, 'transmissionDiscordCommunity'], $mwSsePortal);
    $router->post('/atak/sse/transmissions/relais/{relayId}/supprimer', [SsePortalController::class, 'transmissionDiscordDelete'], $mwSsePortal);
    $router->post('/atak/sse/transmissions/relais/{relayId}/essai', [SsePortalController::class, 'transmissionDiscordTest'], $mwSsePortal);
    $router->get('/atak/sse/transmissions/{id}', [SsePortalController::class, 'transmissionShow'], $mwSsePortal);
    $router->get('/atak/sse/transmissions/{id}/pdf', [SsePortalController::class, 'transmissionPdf'], $mwSsePortal);
    $router->post('/atak/sse/transmissions/{id}/discord', [SsePortalController::class, 'transmissionDiscordSend'], $mwSsePortal);
    ...
    $router->post('/atak/sse/toiles/{id}/entites', [SsePortalController::class, 'meshAddNode'], $mwSsePortal);
    $router->post('/atak/sse/toiles/{id}/liens', [SsePortalController::class, 'meshAddEdge'], $mwSsePortal);
    $router->post('/atak/sse/toiles/{id}/entites/{nodeId}/supprimer', [SsePortalController::class, 'meshDeleteNode'], $mwSsePortal);
    $router->post('/atak/sse/toiles/{id}/liens/{edgeId}/supprimer', [SsePortalController::class, 'meshDeleteEdge'], $mwSsePortal);
    $router->post('/atak/sse/toiles/{id}/disposition', [SsePortalController::class, 'meshSaveLayout'], $mwSsePortal);
    // Laboratoire numérique (ATH-SSE-LABNUM)
    $router->get('/atak/sse/exploitation-numerique', [SseDigitalLabController::class, 'hub'], $mwSsePortal);
    $router->get('/atak/sse/exploitation-numerique/supports', [SseDigitalLabController::class, 'devicesIndex'], $mwSsePortal);
    $router->get('/atak/sse/exploitation-numerique/supports/nouveau', [SseDigitalLabController::class, 'deviceCreateForm'], $mwSsePortal);
    $router->post('/atak/sse/exploitation-numerique/supports', [SseDigitalLabController::class, 'deviceStore'], $mwSsePortal);
    $router->get('/atak/sse/exploitation-numerique/supports/{id}', [SseDigitalLabController::class, 'deviceShow'], $mwSsePortal);
    $router->post('/atak/sse/exploitation-numerique/supports/{id}/acquisitions', [SseDigitalLabController::class, 'acquisitionStore'], $mwSsePortal);
    $router->get('/atak/sse/exploitation-numerique/supports/{id}/telephone', [SseDigitalLabController::class, 'phoneView'], $mwSsePortal);
    $router->get('/atak/sse/exploitation-numerique/supports/{id}/ordinateur', [SseDigitalLabController::class, 'computerView'], $mwSsePortal);
    $router->get('/atak/sse/exploitation-numerique/acquisitions', [SseDigitalLabController::class, 'acquisitionsIndex'], $mwSsePortal);
    $router->get('/atak/sse/exploitation-numerique/acquisitions/{id}', [SseDigitalLabController::class, 'acquisitionShow'], $mwSsePortal);
    ...
    $router->get('/admin/system/storage', [SystemStorageController::class, 'index'], [AuthMiddleware::class, SystemAdminMiddleware::class]);
    ...
    $router->get('/back-office/organisation/catalogue', [OrganizationCatalogController::class, 'index'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->get('/back-office/organisation/catalogue/modele', [OrganizationCatalogController::class, 'show'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->get('/back-office/organisation/catalogue/historique', [OrganizationCatalogController::class, 'history'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->get('/back-office/organisation/catalogue/apercu', [OrganizationCatalogController::class, 'preview'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/organisation/catalogue/appliquer', [OrganizationCatalogController::class, 'apply'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/organisation/catalogue/instantane', [OrganizationCatalogController::class, 'snapshot'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/organisation/catalogue/renommer', [OrganizationCatalogController::class, 'rename'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/organisation/catalogue/actualiser', [OrganizationCatalogController::class, 'refresh'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/organisation/catalogue/retirer', [OrganizationCatalogController::class, 'archive'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/organisation/catalogue/restaurer', [OrganizationCatalogController::class, 'restore'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    ...
    $mwIntegration = [AuthMiddleware::class, OrganizationAdminMiddleware::class];
    $router->get('/back-office/integration-membres', [MemberIntegrationAdminController::class, 'index'], $mwIntegration);
    $router->get('/back-office/integration-membres/modeles', [MemberIntegrationAdminController::class, 'templates'], $mwIntegration);
    $router->get('/back-office/integration-membres/modeles/nouveau', [MemberIntegrationAdminController::class, 'templateEdit'], $mwIntegration);
    $router->post('/back-office/integration-membres/modeles', [MemberIntegrationAdminController::class, 'templateSave'], $mwIntegration);
    $router->get('/back-office/integration-membres/modeles/{id}', [MemberIntegrationAdminController::class, 'templateEdit'], $mwIntegration);
    $router->post('/back-office/integration-membres/modeles/{id}', [MemberIntegrationAdminController::class, 'templateSave'], $mwIntegration);
    $router->get('/back-office/integration-membres/reprise', [MemberIntegrationAdminController::class, 'backfill'], $mwIntegration);
    $router->post('/back-office/integration-membres/reprise', [MemberIntegrationAdminController::class, 'backfillRun'], $mwIntegration);
    $router->post('/back-office/integration-membres/ouvrir', [MemberIntegrationAdminController::class, 'startManual'], $mwIntegration);
    $router->get('/back-office/integration-membres/rendez-vous/{id}/calendrier', [MemberIntegrationAdminController::class, 'calendar'], $mwIntegration);
    $router->get('/back-office/integration-membres/{id}', [MemberIntegrationAdminController::class, 'show'], $mwIntegration);
    $router->post('/back-office/integration-membres/{id}/note', [MemberIntegrationAdminController::class, 'note'], $mwIntegration);
    $router->post('/back-office/integration-membres/{id}/etape', [MemberIntegrationAdminController::class, 'completeStep'], $mwIntegration);
    $router->post('/back-office/integration-membres/{id}/referents', [MemberIntegrationAdminController::class, 'referents'], $mwIntegration);
    $router->post('/back-office/integration-membres/{id}/groupe', [MemberIntegrationAdminController::class, 'matrix'], $mwIntegration);
    $router->post('/back-office/integration-membres/{id}/rendez-vous', [MemberIntegrationAdminController::class, 'appointment'], $mwIntegration);
    $router->post('/back-office/integration-membres/{id}/annuler', [MemberIntegrationAdminController::class, 'cancel'], $mwIntegration);
    $router->post('/back-office/integration-membres/{id}/rouvrir', [MemberIntegrationAdminController::class, 'reopen'], $mwIntegration);
    ...
    $router->get('/back-office/users', [LegacyPersonnelRedirectController::class, 'roster'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->get('/back-office/users/create', [LegacyPersonnelRedirectController::class, 'create'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    ...
    $router->get('/back-office/users/{id}', [LegacyPersonnelRedirectController::class, 'member'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    ...
    $router->post('/back-office/integrations/sse-relais', [OrganizationIntegrationsController::class, 'storeSseRelay'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/integrations/sse-relais/communaute', [OrganizationIntegrationsController::class, 'saveSseCommunity'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/integrations/sse-relais/{relayId}/supprimer', [OrganizationIntegrationsController::class, 'deleteSseRelay'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/integrations/sse-relais/{relayId}/essai', [OrganizationIntegrationsController::class, 'testSseRelay'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    ...
    $router->post('/back-office/planification/{id}/planning', [MissionPlanningController::class, 'updatePlanning'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/planification/{id}/statut', [MissionPlanningController::class, 'updateStatus'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/planification/{id}/organigramme', [MissionPlanningController::class, 'importOrbat'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/planification/{id}/inscrits-evenement', [MissionPlanningController::class, 'importEventRoster'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/planification/{id}/documents', [MissionPlanningController::class, 'updateDocuments'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->get('/back-office/planification/{id}/paquet.pdf', [MissionPlanningController::class, 'exportPdf'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/planification/{id}/postes/{slotId}', [MissionPlanningController::class, 'updateSlot'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/planification/{id}/postes/{slotId}/affecter', [MissionPlanningController::class, 'assignSlot'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/planification/{id}/postes/{slotId}/deplacer', [MissionPlanningController::class, 'moveSlot'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/planification/{id}/postes/{slotId}/rapprocher', [MissionPlanningController::class, 'reconcile'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    ...
    $router->post('/back-office/referentiels/qualifications/attributions/{awardId}/statut', [QualificationReferentielController::class, 'awardTransition'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->get('/back-office/referentiels/qualifications/{id}/edit', [QualificationReferentielController::class, 'edit'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/referentiels/qualifications/{id}/update', [QualificationReferentielController::class, 'update'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/referentiels/qualifications/{id}/archive', [QualificationReferentielController::class, 'archive'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/referentiels/qualifications/{id}/badge', [QualificationReferentielController::class, 'uploadBadge'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/referentiels/qualifications/{id}/niveaux', [QualificationReferentielController::class, 'storeLevel'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/referentiels/qualifications/{id}/niveaux/{levelId}/supprimer', [QualificationReferentielController::class, 'deleteLevel'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/referentiels/qualifications/{id}/prerequis', [QualificationReferentielController::class, 'storePrerequisite'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/referentiels/qualifications/{id}/prerequis/{prereqId}/supprimer', [QualificationReferentielController::class, 'deletePrerequisite'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/referentiels/qualifications/{id}/champs', [QualificationReferentielController::class, 'storeCustomField'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    ...
    $router->get('/back-office/roleplay/sessions/{id}', [RoleplayGameSessionAdminController::class, 'show'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/roleplay/sessions/{id}', [RoleplayGameSessionAdminController::class, 'update'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/roleplay/sessions/{id}/membres/{memberId}', [RoleplayGameSessionAdminController::class, 'memberAction'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    ...
    $router->get('/back-office/ressources/effectifs/nouveau', [UserAdminController::class, 'create'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    $router->post('/back-office/ressources/effectifs/nouveau', [UserAdminController::class, 'store'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    ...
    $router->post('/back-office/ressources/effectifs/departs/{id}/archiver', [EffectifsWorkspaceController::class, 'archiveDepartureDossier'], [AuthMiddleware::class, OrganizationAdminMiddleware::class]);
    ...
    $router->get('/back-office/atak/controle-serveur', [\App\Controllers\Admin\AdminOverwatchServerControlController::class, 'index'], [AuthMiddleware::class, TenantResourceAdminMiddleware::class]);
...
$router->post('/back-office/atak/briefing-slides/{id}/toggle-publish', [AdminBriefingSlidesController::class, 'togglePublish'], [AuthMiddleware::class, TenantResourceAdminMiddleware::class]);
    ...
    $router->get('/back-office/atak/comptes-rendus/modeles', [\App\Controllers\Admin\AdminAarReportsController::class, 'templatesIndex'], [AuthMiddleware::class, TenantResourceAdminMiddleware::class]);
    $router->get('/back-office/atak/comptes-rendus/modeles/nouveau', [\App\Controllers\Admin\AdminAarReportsController::class, 'templatesCreate'], [AuthMiddleware::class, TenantResourceAdminMiddleware::class]);
    $router->post('/back-office/atak/comptes-rendus/modeles', [\App\Controllers\Admin\AdminAarReportsController::class, 'templatesStore'], [AuthMiddleware::class, TenantResourceAdminMiddleware::class]);
    $router->get('/back-office/atak/comptes-rendus/modeles/{id}', [\App\Controllers\Admin\AdminAarReportsController::class, 'templatesEdit'], [AuthMiddleware::class, TenantResourceAdminMiddleware::class]);
    $router->post('/back-office/atak/comptes-rendus/modeles/{id}', [\App\Controllers\Admin\AdminAarReportsController::class, 'templatesUpdate'], [AuthMiddleware::class, TenantResourceAdminMiddleware::class]);
    $router->post('/back-office/atak/comptes-rendus/modeles/{id}/archiver', [\App\Controllers\Admin\AdminAarReportsController::class, 'templatesArchive'], [AuthMiddleware::class, TenantResourceAdminMiddleware::class]);
    $router->post('/back-office/atak/comptes-rendus/modeles/{id}/reactiver', [\App\Controllers\Admin\AdminAarReportsController::class, 'templatesRestore'], [AuthMiddleware::class, TenantResourceAdminMiddleware::class]);
    ...
    $router->post('/api/atak/web-log', [AtakApiController::class, 'webLogStore']);
    ...
    $router->get('/api/atak/mission-plan/unit', [AtakMissionApiController::class, 'unit']);
    $router->get('/api/atak/mission-plan/pdf', [AtakMissionApiController::class, 'pdf']);
    $router->post('/api/atak/mission-plan/phase', [AtakMissionApiController::class, 'setPhase']);
    $router->post('/api/atak/mission-plan/timeline', [AtakMissionApiController::class, 'addTimeline']);
    $router->post('/api/atak/mission-plan/graphics/{id}', [AtakMissionApiController::class, 'placeGraphic']);
    $router->post('/api/atak/mission-plan/graphics/{id}/state', [AtakMissionApiController::class, 'graphicState']);
    ...
    $router->post('/api/atak/game-session/check-in', [AtakApiController::class, 'gameSessionCheckIn']);
    $router->post('/api/atak/game-session/check-out', [AtakApiController::class, 'gameSessionCheckOut']);
    ...
    // LOT 1 — Intelligence Workspace API v1
    $router->get('/api/sse/v1/workspace/summary', [SseIntelApiController::class, 'workspaceSummary']);
    $router->get('/api/sse/v1/inbox', [SseIntelApiController::class, 'inboxIndex']);
    $router->post('/api/sse/v1/inbox/decide', [SseIntelApiController::class, 'inboxDecide']);
    $router->get('/api/sse/v1/graph', [SseIntelApiController::class, 'graphIndex']);
    $router->get('/api/sse/v1/search', [SseIntelApiController::class, 'searchIndex']);
    $router->get('/api/sse/v1/entities', [SseIntelApiController::class, 'entitiesIndex']);
    $router->get('/api/sse/v1/entities/{uuid}', [SseIntelApiController::class, 'entitiesShow']);
    $router->get('/api/sse/v1/events', [SseIntelApiController::class, 'eventsIndex']);
    $router->get('/api/sse/v1/relations', [SseIntelApiController::class, 'relationsIndex']);
    $router->post('/api/sse/v1/relations', [SseIntelApiController::class, 'relationsStore']);
    $router->post('/api/sse/v1/relations/{id}/supprimer', [SseIntelApiController::class, 'relationsDelete']);
    $router->get('/api/sse/v1/cases/{id}/folder', [SseIntelApiController::class, 'caseFolderShow']);
    $router->post('/api/sse/v1/cases/{id}/folder', [SseIntelApiController::class, 'caseFolderUpdate']);
    $router->post('/api/sse/v1/terrain/photos', [SseIntelApiController::class, 'terrainPhotoStore']);
    $router->post('/api/sse/v1/terrain/seizures/{id}/custody', [SseIntelApiController::class, 'terrainCustodyUpdate']);
    $router->post('/api/sse/v1/terrain/persons/{id}/seek', [SseIntelApiController::class, 'terrainSeekAdvance']);
    $router->get('/api/sse/v1/cycle', [SseIntelApiController::class, 'cycleBoard']);
    $router->post('/api/sse/v1/cycle/requirements', [SseIntelApiController::class, 'cycleRequirementStore']);
    $router->post('/api/sse/v1/cycle/requirements/{id}/statut', [SseIntelApiController::class, 'cycleRequirementStatus']);
    $router->post('/api/sse/v1/cycle/taskings', [SseIntelApiController::class, 'cycleTaskingStore']);
    $router->post('/api/sse/v1/cycle/taskings/{id}', [SseIntelApiController::class, 'cycleTaskingUpdate']);
    $router->post('/api/sse/v1/cycle/products/generer', [SseIntelApiController::class, 'cycleProductGenerate']);
    $router->post('/api/sse/v1/cycle/products/{id}/valider', [SseIntelApiController::class, 'cycleProductValidate']);
    $router->post('/api/sse/v1/cycle/products/{id}/sanitiser', [SseIntelApiController::class, 'cycleProductSanitise']);
    $router->post('/api/sse/v1/cycle/products/{id}/diffuser', [SseIntelApiController::class, 'cycleProductDiffuse']);
    $router->get('/api/sse/v1/analysis', [SseIntelApiController::class, 'analysisBoard']);
    $router->post('/api/sse/v1/analysis/findings/{id}/decide', [SseIntelApiController::class, 'analysisFindingDecide']);
    $router->get('/api/sse/v1/health', [SseIntelApiController::class, 'syncHealth']);
    $router->get('/api/sse/v1/sync/monitor', [SseIntelApiController::class, 'syncMonitor']);
    $router->post('/api/sse/v1/sync/optimize', [SseIntelApiController::class, 'syncOptimize']);
    $router->get('/api/sse/v1/sync/pending', [SseIntelApiController::class, 'syncPending']);
    $router->post('/api/sse/v1/sync/enqueue', [SseIntelApiController::class, 'syncEnqueue']);
    ...
    $router->post('/api/atak/terrain/viewshed', [\App\Controllers\Api\AtakTerrainApiController::class, 'viewshed']);
    $router->post('/api/atak/terrain/horizon', [\App\Controllers\Api\AtakTerrainApiController::class, 'horizon']);
    $router->post('/api/atak/terrain/slice', [\App\Controllers\Api\AtakTerrainApiController::class, 'slice']);
    $router->post('/api/atak/terrain/measure', [\App\Controllers\Api\AtakTerrainApiController::class, 'measure']);
    $router->get('/api/atak/terrain/rgb/{z}/{x}/{y}', [\App\Controllers\Api\AtakTerrainApiController::class, 'rgbTile']);
    ...
    $router->get('/api/atak/scene/mesh', [\App\Controllers\Api\AtakSceneApiController::class, 'mesh']);
    $router->get('/api/atak/scene/object', [\App\Controllers\Api\AtakSceneApiController::class, 'show']);
    $router->post('/api/atak/scene/anchor', [\App\Controllers\Api\AtakSceneApiController::class, 'anchor']);
