 ...
 *
 * Appelée depuis run-migrations.php et, en secours, depuis le dépôt
 * RecruitmentDiscordQuestionRepository si le code est déployé avant la migration.
 */
if (!function_exists('ensure_discord_recruitment_schema')) {
    function ensure_discord_recruitment_schema(PDO $pdo): void
    {
        static $done = false;
        if ($done) {
            return;
...
return static function (PDO $pdo): void {
    ensure_discord_recruitment_schema($pdo);
};
