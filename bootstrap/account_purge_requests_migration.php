...
/**
 * Demandes organisateur → plateforme : purge définitive d’un « Compte supprimé ».
 * Idempotent.
 */
function run_account_purge_requests_migration(PDO $pdo): void
{
    $st = $pdo->query(
    ...
    try {
        ...
        echo "  account_purge_requests : table créée.\n";
    } catch (Throwable $e) {
