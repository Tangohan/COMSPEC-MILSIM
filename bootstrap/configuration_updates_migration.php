...
SQL
    ...
    $seeds = [
        ...
        [
            'code' => 'DASHBOARD_WARDROBE_SHOWCASE_V1',
            'version' => '1',
            'title' => 'Tenues en vitrine sur le tableau de bord',
            'description' => 'Mettez en avant les tenues de votre communauté, comme le catalogue des formations. Un PNG de personnage (fond transparent) se place devant le fond.',
            'configuration_level' => 'recommended',
            'configure_path' => 'back-office/dashboard-tenues',
            'estimate_minutes' => 8,
            'mandatory' => 0,
            'blocking' => 0,
            'dismissible' => 1,
        ...
        [
            'code' => 'JOB_CATALOGS_FR_US_V1',
            'version' => '1',
            'title' => 'Catalogues d’emplois Armée française et SOF américain',
            'description' => 'Deux modèles d’emplois sont disponibles : Armée française (compagnie de combat et détachement des forces spéciales) et SOF américain (détachement, Rangers, action navale, guerre spéciale aérienne). Copiez celui qui correspond à votre communauté. Les niveaux d’accès ne changent pas.',
            'configuration_level' => 'recommended',
            'configure_path' => 'back-office/organisation/catalogue',
            'estimate_minutes' => 8,
            'mandatory' => 0,
