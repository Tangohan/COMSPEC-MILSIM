...
Laboratoire numérique (`ATH-SSE-LABNUM`) : voir le [dictionnaire dédié](../08-exploitation-numerique/dictionnaire-donnees.md) (`sse_digital_devices`, `sse_digital_acquisitions`, `sse_digital_artifacts`, `sse_digital_findings`, etc.).
