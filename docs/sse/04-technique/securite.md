...
Le laboratoire numérique ajoute des exigences spécifiques (accès distinct, prévisualisation isolée, antivirus à l’import, liens temporaires) : voir [Sécurité exploitation numérique](../08-exploitation-numerique/securite.md).
