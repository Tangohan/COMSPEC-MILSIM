...
Depuis le **tableau opérationnel** du back-office, un responsable ouvre aussi les **événements** à venir, les **articles** de la communauté et le **poste ATAK** (situation, sessions, carte tactique, cycle de mission et comptes rendus), ainsi que les missions, les annonces, les effectifs et le courrier. Ces raccourcis mènent aux écrans déjà existants : rien n'est recopié, on pilote depuis un même poste.
