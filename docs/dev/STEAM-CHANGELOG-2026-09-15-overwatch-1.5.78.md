# Changelog Steam — Overwatch 1.5.78 (15/09/2026)
...
Avec le téléphone ATAK ouvert et la liaison active, le jeu pouvait se fermer tout seul, sans message. Le cadre de l’écran est désormais figé : la carte, le tiroir d’applications et l’écran d’accueil ne se calent plus hors limites.

[h2]Correction — Messagerie[/h2]
Depuis un canal, le retour ramène bien à la liste des canaux. Le fil se recharge.

[h2]Nouveau — Overwatch Beta et téléphone[/h2]
Le poste Overwatch Beta envoie désormais une alerte plein écran, une tâche de groupe, des points à atteindre (20 m) et un point de ralliement (50 m). Cap, vitesse, altitude et état de liaison remontés depuis Arma s’affichent sur la fiche contact.

[list]
[*] Alerte plein écran : téléphone ouvert ou en position mini
[*] Points à atteindre confirmés dès qu’un téléphone entre dans le rayon
