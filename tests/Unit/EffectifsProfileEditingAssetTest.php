...
final class EffectifsProfileEditingAssetTest extends TestCase
{
    public function testProfileManagementConvergesOnTheMemberFile(): void
    {
        ...
        self::assertStringContainsString("effectifs/membres/{id}/modifier', [LegacyPersonnelRedirectController::class, 'member']", $routes);
        ...
        self::assertStringNotContainsString("effectifs_workspace_url('membres/' . \$id . '/modifier')", $member);
        self::assertIsString($roster);
        self::assertStringContainsString("\$personnelEditUrl = effectifs_workspace_url('membres/' . \$id);", $roster);
