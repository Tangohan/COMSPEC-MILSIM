...
final class AtakOverwatchBetaAssetTest extends TestCase
{
    public function testBetaWorkspaceRouteAndCoreInteractionsArePresent(): void
    {
        ...
        self::assertStringContainsString('renderAirAssetsOnMap', $overwatchJs);
        self::assertStringContainsString('setGpsVehiclesOnMap', $overwatchJs);
        self::assertStringContainsString('setAirAssets', $overwatchJs);
        ...
        self::assertStringContainsString('var LIVE_TTL_SEC = 180', $overwatchJs);
