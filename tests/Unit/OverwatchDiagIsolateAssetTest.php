...
final class OverwatchDiagIsolateAssetTest extends TestCase
{
    public function testDiagIsolateUiGatesEachUplinkBrick(): void
    {
        ...
        self::assertStringContainsString('Rep�re de test', $catalog);
        self::assertStringContainsString('Photo et transmission', $catalog);
        self::assertStringContainsString('Ordres (r�ception)', $catalog);
        ...
        self::assertStringContainsString('affichage report�', $pollOrders);
        ...
        self::assertStringContainsString('D�pannage liaison', $html);
        self::assertStringContainsString('tool:diagisolate', $js);
        self::assertStringContainsString('D�pannage liaison', $ace);
        ...
        self::assertStringContainsString('Message de test envoy� vers le poste', $probe);
        ...
        self::assertStringContainsString('D�pannage liaison demand�', $launch);
        self::assertStringContainsString('diagIsolateStart', $launch);
        self::assertStringContainsString('9606', $esc);
        self::assertStringContainsString('D�pannage liaison', $esc);
        self::assertStringNotContainsString('ctrlSetText "COMSPEC Overwatch"', $esc);
        self::assertStringContainsString('9606', $pauseHpp);
        self::assertStringContainsString('D�pannage liaison � lancer maintenant', $html);
        self::assertStringContainsString('un message, un rep�re et une photo', $html);
