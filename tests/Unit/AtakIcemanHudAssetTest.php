...
final class AtakIcemanHudAssetTest extends TestCase
{
    public function testMapHudStaysOnTheMapPane(): void
    {
        ...
        self::assertStringContainsString('NOM', $upd);
        self::assertStringContainsString('GROUPE', $upd);
        self::assertStringContainsString('FONCTION', $upd);
        self::assertStringContainsString('POSITION', $upd);
        self::assertStringContainsString('inGameGroupLabel', $upd);
        self::assertStringContainsString('comspec_profile_name', $upd);
        self::assertStringContainsString('comspec_profile_function', $upd);
        ...
        self::assertStringContainsString('17000 + 12012', $upd);
        self::assertStringContainsString('ctrlParentControlsGroup', $upd);
        self::assertStringContainsString('_idH', $upd);
