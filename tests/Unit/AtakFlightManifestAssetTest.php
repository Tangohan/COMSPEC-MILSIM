...
final class AtakFlightManifestAssetTest extends TestCase
{
    public function testManifestHasMissionFieldsAndGroundFriendlyCopy(): void
    {
        ...
        self::assertStringContainsString('Fréquence', $air);
