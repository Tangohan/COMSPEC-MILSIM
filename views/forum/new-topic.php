        ...
        <div class="border border-rose-200 bg-rose-50/60 rounded-md p-4 space-y-3">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input type="text" id="mission-priority-role" class="w-full bg-white border border-slate-200 text-slate-900 px-3 py-2 rounded-md text-sm" placeholder="all / command / instructors">
            </div>
          </div>
          <div class="flex flex-col sm:flex-row sm:items-center gap-3">
            <label class="inline-flex items-center gap-2 text-[10px] font-bold text-slate-700">
              <input type="checkbox" id="mandatory-read" class="rounded border-slate-300 text-emerald-600">
              Lecture obligatoire (accusé de réception)
            </label>
            <input type="datetime-local" id="mandatory-read-due-at" class="bg-white border border-slate-200 text-slate-900 px-3 py-2 rounded-md text-sm" aria-label="Échéance de lecture obligatoire">
          </div>
        </div>
        <?php endif; ?>
