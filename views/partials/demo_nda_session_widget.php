...
$deniedUrl = url(ltrim(\App\Services\DemoNda\DemoNdaGateService::GATE_PATH, '/'));
?>
<div
    id="demo-nda-timer"
    ...
    data-denied-url="<?= htmlspecialchars($deniedUrl, ENT_QUOTES, 'UTF-8') ?>"
>
    <p class="demo-nda-timer__label">Accès démo</p>
...
.demo-nda-timer.is-critical {
    border-color: rgba(248, 113, 113, 0.65);
    animation: demo-nda-pulse 1.1s ease-in-out infinite;
}
.demo-nda-timer.is-critical .demo-nda-timer__label { color: rgba(254, 202, 202, 0.9); }
...
(function () {
    ...
    var deniedUrl = root.getAttribute('data-denied-url') || '/';
