...
(function() {
  ...
  if (!document.getElementById('alert-banners-keyframes')) {
    ...
    st.textContent = [
      ...
      '.alert-banners-stack--tiles{background:#050505;border-bottom:1px solid #111;padding:0.85rem 1rem}',
      '@media (min-width:768px){.alert-banners-stack--tiles{padding:1rem 1.5rem}}',
      '@media (min-width:1024px){.alert-banners-stack--tiles{padding:1.1rem 2rem}}',
      '.alert-banners-shell.dash-announce{background:transparent;border:0;padding:0;max-width:1800px;margin:0 auto}',
