...
<div id="tenant-intervention-banner" class="sticky top-0 z-[100] bg-amber-400 text-slate-950 shadow-lg px-4 py-3" role="status">
 <div class="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3">
  <button type="button" onclick="document.getElementById('tenant-intervention-modal').showModal()" class="font-black tracking-wide"><?= $isManager ? 'Administration de l’organisation — '.htmlspecialchars($tenantName,ENT_QUOTES,'UTF-8') : 'Un gestionnaire analyse et corrige votre organisation' ?></button>
