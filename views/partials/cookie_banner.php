...
<div id="portal-cookie-banner" class="hidden fixed bottom-0 inset-x-0 z-[300] p-4 md:p-6" role="dialog" aria-labelledby="cookie-banner-title" aria-live="polite" aria-modal="false" hidden>
    <div class="max-w-5xl mx-auto rounded-2xl border border-slate-200 bg-white shadow-2xl px-5 py-4 sm:px-6 sm:py-5 md:px-8 md:py-6 flex flex-col gap-4">
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between md:gap-6 lg:gap-8">
            <div class="min-w-0 flex-1 space-y-2 md:pr-2">
            ...
            <div class="grid grid-cols-2 gap-2 w-full shrink-0 sm:flex sm:flex-row sm:flex-wrap sm:justify-end sm:gap-2 sm:w-auto">
                <button type="button" id="portal-cookie-essential-only" class="w-full px-3 py-2.5 sm:px-4 sm:w-auto rounded-xl border border-slate-200 text-[10px] font-black uppercase tracking-widest text-slate-700 hover:bg-slate-50 transition-colors">
                    Nécessaires uniquement
                </button>
                <button type="button" id="portal-cookie-customize" class="w-full px-3 py-2.5 sm:px-4 sm:w-auto rounded-xl border border-slate-200 text-[10px] font-black uppercase tracking-widest text-slate-700 hover:bg-slate-50 transition-colors" aria-expanded="false" aria-controls="portal-cookie-panel">
                    Personnaliser
                </button>
                <button type="button" id="portal-cookie-reject-all" class="w-full px-3 py-2.5 sm:px-4 sm:w-auto rounded-xl border border-slate-300 bg-slate-50 text-[10px] font-black uppercase tracking-widest text-slate-800 hover:bg-slate-100 transition-colors">
                    Tout refuser
                </button>
                <button type="button" id="portal-cookie-accept-all" class="w-full px-3 py-2.5 sm:px-4 sm:w-auto rounded-xl bg-slate-900 text-white text-[10px] font-black uppercase tracking-widest hover:bg-emerald-700 transition-colors shadow-sm">
                    Tout accepter
                </button>
            </div>
        </div>
