...
<div id="portal-cookie-banner" class="hidden fixed bottom-0 inset-x-0 z-[300] p-4 md:p-6" role="dialog" aria-labelledby="cookie-banner-title" aria-live="polite" aria-modal="false" hidden>
    <div class="max-w-5xl mx-auto rounded-2xl border border-slate-200 bg-white shadow-2xl px-5 py-4 sm:px-6 sm:py-5 md:px-8 md:py-6 flex flex-col gap-4">
        <div class="flex flex-col gap-4 md:flex-row md:items-start md:gap-5 lg:gap-6">
            ...
            <div class="flex flex-col gap-2.5 w-full shrink-0 md:w-80 lg:w-96" role="group" aria-label="<?= htmlspecialchars(__('cookies.choices_aria'), ENT_QUOTES, 'UTF-8') ?>">
                <div class="flex flex-wrap gap-x-4 gap-y-1 justify-center md:justify-end">
                    <button type="button" id="portal-cookie-essential-only" class="text-[10px] font-black uppercase tracking-widest text-slate-500 hover:text-slate-800 underline-offset-4 hover:underline transition-colors">
                        <?= htmlspecialchars(__('cookies.essential_only'), ENT_QUOTES, 'UTF-8') ?>
                    </button>
                    <button type="button" id="portal-cookie-customize" class="text-[10px] font-black uppercase tracking-widest text-slate-500 hover:text-slate-800 underline-offset-4 hover:underline transition-colors" aria-expanded="false" aria-controls="portal-cookie-panel">
