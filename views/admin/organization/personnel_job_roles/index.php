...
<div class="mx-auto max-w-6xl px-6 py-12">
    ...
    <div class="mb-6 grid gap-4 lg:grid-cols-[1.4fr_1fr] lg:items-start">
        <div>
            <h1 class="text-2xl font-black text-slate-900">Emplois de l’organigramme</h1>
            <p class="mt-1 max-w-2xl text-sm text-slate-600">Chaque unité de l’ORBAT a déjà un emploi. Vous pouvez en créer d’autres. Ce sont des libellés de dossier, distincts des niveaux d’accès.</p>
        </div>
