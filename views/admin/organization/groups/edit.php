        ...
        <div class="border-t border-slate-200 pt-4 space-y-3">
            ...
            <div class="grid gap-3 sm:grid-cols-3">
                <div>
                    ...
                    <input type="number" min="0" id="public_capacity" name="public_capacity" value="<?= htmlspecialchars((string) ($group['public_capacity'] ?? '')) ?>" class="mt-1 block w-full px-3 py-2 border border-slate-300 rounded-md shadow-sm text-sm" placeholder="32">
                </div>
                <div>
                    ...
                    <input type="text" id="public_open_slots" name="public_open_slots" value="<?php
                        $slots = $group['public_open_slots'] ?? null;
                ...
                <div>
                    ...
                    <input type="text" id="public_accent_color" name="public_accent_color" value="<?= htmlspecialchars((string) ($group['public_accent_color'] ?? '')) ?>" maxlength="7" class="mt-1 block w-full px-3 py-2 border border-slate-300 rounded-md shadow-sm text-sm font-mono" placeholder="#0B8A5C">
                </div>
            </div>
            <div>
