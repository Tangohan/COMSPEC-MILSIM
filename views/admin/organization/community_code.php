...
<div class="max-w-xl mx-auto px-6 py-12">
    ...
    <p class="text-slate-600 text-sm mb-8">Nom affiché, adresse publique <code class="bg-slate-100 px-1 rounded">/c/…</code> et code court pour rejoindre (<code class="bg-slate-100 px-1 rounded">/join</code>).</p>
    ...
    <form method="post" action="<?= url('admin/organization/community') ?>" class="space-y-4">
        <?= \App\Core\Csrf::field() ?>
        <div>
    ...
    <p class="mt-8"><a href="<?= url('admin/organization') ?>" class="text-sm text-slate-600 underline">Retour administration organisation</a></p>
</div>
