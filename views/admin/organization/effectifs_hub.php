...
$hubRows = [
    ...
    [
        'id' => 'rh-documents',
        'title' => 'Documents RH',
        'desc' => 'Coffre typé du dossier : candidature, charte, certificats, affectations, évaluations.',
        'domain' => 'Quotidien RH',
        'domainKey' => 'rh',
        'href' => function_exists('effectifs_workspace_url') ? effectifs_workspace_url('documents-rh') : url('back-office/ressources/effectifs/documents-rh'),
        'volume' => 'Dossier individuel',
    ...
    [
        ...
        'desc' => 'Changements d’unité, candidatures à un poste et souhaits d’évolution.',
        'domain' => 'Quotidien RH',
        'domainKey' => 'rh',
        'href' => function_exists('effectifs_workspace_url') ? effectifs_workspace_url('mobilite') : url('back-office/ressources/effectifs/mobilite'),
        'volume' => 'Demandes RH',
        'cta' => 'Voir la mobilité',
        'primary' => false,
        'ok' => true,
    ],
    [
        ...
        'desc' => 'Personnes prêtes maintenant, sous 3 mois ou à développer pour les postes de responsabilité.',
        'domain' => 'Carrière',
        'domainKey' => 'carriere',
        'href' => function_exists('effectifs_workspace_url') ? effectifs_workspace_url('vivier') : url('back-office/ressources/effectifs/vivier'),
        'volume' => 'Vivier de succession',
        'cta' => 'Ouvrir le vivier',
        'primary' => false,
        'ok' => true,
    ],
    [
        'id' => 'rh-alerts',
        'title' => 'Alertes RH',
        'desc' => 'Qualifications à recyclage, absences prolongées, inactivité, postes sous-pourvus.',
        'domain' => 'Quotidien RH',
        'domainKey' => 'rh',
        'href' => function_exists('effectifs_workspace_url') ? effectifs_workspace_url('alertes') : url('back-office/ressources/effectifs/alertes'),
        'volume' => 'Pilotage',
