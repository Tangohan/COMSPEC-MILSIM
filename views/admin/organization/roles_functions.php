...
<div class="max-w-6xl mx-auto px-4 sm:px-6 py-10 lg:py-12 space-y-8">
    ...
    <?php if ($success): ?>
        <?php $flash_message = (string) $success; $flash_variant = 'success'; $flash_margin_class = 'ath-rise'; include base_path('views/partials/flash_message.php'); ?>
    <?php endif; ?>
    <?php if ($error): ?>
        <?php $flash_message = (string) $error; $flash_variant = 'error'; $flash_margin_class = 'ath-rise'; include base_path('views/partials/flash_message.php'); ?>
    <?php endif; ?>
