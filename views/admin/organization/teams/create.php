...
<div class="max-w-2xl mx-auto px-6 py-12">
    <h1 class="text-2xl font-black text-slate-900 mb-6">Nouvelle équipe</h1>
    <form method="post" action="<?= url('admin/organization/teams/store') ?>" class="space-y-4">
        <?= \App\Core\Csrf::field() ?>
        <div>
        ...
        <div class="flex gap-3 pt-4">
            ...
            <a href="<?= url('admin/organization/teams') ?>" class="px-4 py-2 text-slate-600 text-sm hover:underline">Annuler</a>
        </div>
    </form>
</div>
