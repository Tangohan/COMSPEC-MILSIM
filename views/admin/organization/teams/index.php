...
<div class="max-w-4xl mx-auto px-6 py-12">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="<?= url('back-office/teams/create') ?>" class="px-4 py-2 bg-slate-900 text-white text-sm font-semibold rounded hover:bg-slate-800">Nouvelle équipe</a>
    </div>
    ...
    <table class="w-full border border-slate-200 rounded-lg overflow-hidden">
        ...
        <tbody>
            ...
            <tr class="border-b border-slate-100 hover:bg-slate-50">
                ...
                <td class="p-3">
                    <a href="<?= url('back-office/teams/' . $t['id']) ?>" class="text-slate-600 hover:underline text-sm">Voir</a>
                    <span class="mx-1">|</span>
                    <a href="<?= url('back-office/teams/' . $t['id'] . '/edit') ?>" class="text-slate-600 hover:underline text-sm">Modifier</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
