    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm flex flex-col">
            ...
            <div class="flex flex-col gap-2">
                ...
                <a href="<?= url('admin/system/military-referential') ?>" class="inline-flex items-center justify-center rounded-lg border border-slate-200 bg-white px-3 py-2.5 text-xs font-semibold text-slate-800 hover:bg-slate-50">Référentiel militaire SOF</a>
