...
$docBodyHtml = (string) ($docBodyHtml ?? '');
$docKey = $docKey ?? '';
?>
<div class="site-docs">
    <div class="site-docs__shell site-docs__shell--refs">
        <nav class="site-docs__refs-nav mb-4 text-sm" aria-label="Navigation documentation">
            ...
            <a href="<?= htmlspecialchars(url('documentation/references'), ENT_QUOTES, 'UTF-8') ?>" class="font-semibold text-slate-600 underline decoration-slate-300 underline-offset-2 hover:text-sky-800">Documentation technique du mod</a>
            ...
            <header>
                <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                    <div>
                        ...
                        <p class="site-docs__file-meta">Fiche technique mod — développeurs &amp; intégrateurs.</p>
                    </div>
