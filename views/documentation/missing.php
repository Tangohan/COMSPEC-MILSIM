...
<div class="site-docs">
    <div class="site-docs__shell site-docs__shell--refs">
        <a href="<?= htmlspecialchars(url('documentation/references'), ENT_QUOTES, 'UTF-8') ?>" class="site-docs__refs-back">← Documentation technique du mod</a>
        <div class="site-docs__file-card mt-6">
            ...
            <div class="site-docs__file-body">
                ...
                <p class="mt-4 flex flex-wrap gap-4 text-sm">
                    ...
                    <a href="<?= htmlspecialchars(url('documentation/references'), ENT_QUOTES, 'UTF-8') ?>" class="text-slate-600 hover:underline">Documentation technique du mod</a>
                </p>
            </div>
        </div>
    </div>
