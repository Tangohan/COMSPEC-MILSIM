...
$matriculeInternal = trim((string) ($personnelProfile['matricule_internal'] ?? $personnelExtras['service_number'] ?? ''));
...
$matricule = $tenantMemberNumber !== '' ? $tenantMemberNumber : ($matriculeInternal !== '' ? $matriculeInternal : null);
            ...
            <div class="personnel-file-main order-1 lg:order-2 min-w-0 space-y-5 lg:col-span-9" :class="{ 'personnel-file-main--full': tab === 'tableau' }">
                ...
                <section class="bg-white border border-slate-200 rounded-3xl p-8 shadow-sm">
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div><p class="text-[7px] font-black text-slate-400 uppercase tracking-widest mb-1"><?= htmlspecialchars($tenantMemberNumber !== '' ? $tenantMemberNumberLabel : 'Matricule', ENT_QUOTES, 'UTF-8') ?></p><p class="text-sm font-black text-slate-900 font-mono"><?= !empty($showMatriculePublic) ? ($matricule ? htmlspecialchars($matricule) : '—') : '—' ?></p></div>
