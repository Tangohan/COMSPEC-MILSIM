 ...
 * Utilisée pour le pilotage communautaire /formation (vue d’ensemble).
 */
        ...
        <div class="grid lg:grid-cols-[290px_1fr] min-h-screen">
            ...
            <main class="p-5 md:p-8 lg:p-10 space-y-8">
                ...
                <div class="lms-infobanner" role="note">
                    ...
                    <p><strong>Pilotage.</strong> Vue réservée aux rôles formation de la communauté. Le menu à gauche reprend le même accès que le <a href="<?= htmlspecialchars($lmsBase) ?>/formations" class="text-emerald-700 font-semibold hover:underline">catalogue formations</a> ; les cartes ci-dessous ouvrent studio, catalogue éditeur et assignations.</p>
                </div>
                <?php
